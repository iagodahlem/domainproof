...
export interface ClaimInsert {
  ...
  /** Stamped from a component session's mint-time `externalId`, if this claim was made through one — see `infra/db/schema.ts`'s `domains.externalId` doc comment. `undefined` for every other claim path. */
  externalId?: string
