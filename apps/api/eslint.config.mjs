...
export default [
  ...
  },
  {
    ...
    rules: {
      "no-restricted-imports": [
        "error",
        {
          patterns: [...EXTENSIONLESS_IMPORT_PATTERNS, INFRA_ADAPTER_PATTERN, MODULES_NO_APIS_PATTERN],
        },
      ],
    },
  },
  {
    ...
    rules: {
      "no-restricted-imports": [
        "error",
        {
          patterns: [...EXTENSIONLESS_IMPORT_PATTERNS, INFRA_DB_PATTERN, MODULES_NO_APIS_PATTERN],
        },
      ],
    },
  },
  ...
  },
  {
    ...
    rules: {
      "no-restricted-imports": [
        "error",
        { patterns: [...EXTENSIONLESS_IMPORT_PATTERNS, NO_APIS_DASHBOARD_PATTERN] },
      ],
    },
  },
];
