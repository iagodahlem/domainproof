...
export function ShellSkeleton() {
  return (
    ...
    >
      <div className="flex w-52 shrink-0 flex-col border-r border-border bg-surface max-[760px]:w-full max-[760px]:flex-row max-[760px]:items-center max-[760px]:gap-4 max-[760px]:border-r-0 max-[760px]:border-b max-[760px]:p-4">
        ...
        <div className="hidden h-5.5 w-5.5 shrink-0 animate-pulse rounded-sm bg-surface-3 max-[760px]:flex" />
        <div className="flex flex-col gap-0.5 p-3 max-[760px]:flex-row max-[760px]:gap-2 max-[760px]:p-0">
