 ...
 */
export type FixtureError = { error: Exclude<TxtResolutionFailureReason, "no_records"> };
 ...
 */
export function createFixtureResolver(zones: Record<string, FixtureZone> = {}): FixtureResolver {
